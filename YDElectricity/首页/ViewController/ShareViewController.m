...
-(void)setUpShareImageSubView{
    ...
    if (self.tbkVM) {
        ...
        // 带 logo 的二维码
       self.twoCodeImage.image = [SGQRCodeObtain generateQRCodeWithData:self.tbkVM.buyURL size:51 logoImage:[UIImage imageNamed:@"sns_icon_24"] ratio:0.15];
//        self.twoCodeImage.image = [SGQRCodeObtain generateQRCodeWithData:@"https://detail.tmall.com/item.htm?id=556058538289" size:51];
        //在售价
        self.sallingPrice.text = self.tbkVM.discountPrice;
        //券后价
        self.discountPriceTwo.text = self.tbkVM.discountPrice;
        //购买链接
        self.buyLink.text = self.tbkVM.buyURL;
