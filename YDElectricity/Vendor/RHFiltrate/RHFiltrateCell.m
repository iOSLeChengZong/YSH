...
//        _lab_title.layer.borderWidth = 1.0;
        ...
        _lab_title.textColor = kFONTSlectRGB;//[UIColor orangeColor];
    } else {
        
//        _lab_title.layer.borderWidth = 0.0;
//        _lab_title.backgroundColor = kRGBA(245, 245, 245, 1.0);
        _lab_title.textColor = KFontDefaultRGB;//kRGBA(77, 77, 77, 1.0);
    }
}
...
//        _lab_title.layer.borderColor = [UIColor orangeColor].CGColor;
